...
globalStyle(
  `${styles.contents} .timeline-item:has(+ .timeline-item)::before`,
  {
    content: '""',
    position: "absolute",
    top: `calc(${titleLineHeight} / 2)`,
...
// Shiki dual theme (was .astro-code)
globalStyle(
  `.dark ${styles.contents} .shiki, .dark ${styles.contents} .shiki span`,
  {
...
// Code highlighting
globalStyle(`${styles.contents} .shiki .line.highlighted`, {
...
globalStyle(`${styles.contents} .shiki .line.diff.add`, {
  vars: {
    [diffColorVars]: "16, 185, 129",
  },
});

globalStyle(`${styles.contents} .shiki .line.diff.remove`, {
  vars: {
    [diffColorVars]: "244, 63, 94",
  },
});

globalStyle(`${styles.contents} .shiki .line.diff`, {
  position: "relative",
  width: `calc(100% + ${CODEBLOCK_PADDING} * 2)`,
  margin: `0 calc(-1 * ${CODEBLOCK_PADDING})`,
  padding: `0 ${CODEBLOCK_PADDING}`,
...
globalStyle(`${styles.contents} .shiki .line.diff:before`, {
  position: "absolute",
  top: 0,
  left: 0,
  width: "1rem",
...
globalStyle(`${styles.contents} .shiki .line.diff.add:before`, {
  content: '"+"',
});

globalStyle(`${styles.contents} .shiki .line.diff.remove:before`, {
  content: '"-"',
});
