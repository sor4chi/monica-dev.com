...
globalStyle(`.light ${item}::before`, {
  background: "linear-gradient(to bottom, rgba(128, 128, 128, 0.2) 0%, rgba(0, 0, 0, 0.6) 100%)",
});

globalStyle(`.dark ${item}::before`, {
  background: "linear-gradient(to bottom, rgba(128, 128, 128, 0.1) 0%, rgba(0, 0, 0, 0.8) 100%)",
});
